<nav x-data="{ open: false }" class="bg-green-900 border-b border-green-0">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 inline-flex items-center">
                    ...
                    <a href="{{ route('dashboard') }}" class="text-white pl-4 text-lg font-bold">
                        <img src="{{ asset('img/solocalc_text.png')}}" alt="" class="w-25 h-32">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('propriedades.index')" :active="request()->routeIs('propriedades.index')">
                        {{ __('Propriedades') }}
                    </x-nav-link>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')">
                            <i class="bi bi-person-circle"></i> {{ __('Perfil') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                ...
                                <i class="bi bi-arrow-right-circle"></i> {{ __('Sair') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
                </x-dropdown>
